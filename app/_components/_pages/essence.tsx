    ...
    return <>
        <div id="essence" className="w-full h-auto min-h-screen bg-gray-100 px-4 py-8 md:px-42 md:py-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-[32px]">
                {cards.map((card) => (
                    <div key={card.name} className={`bg-white border ${borderMap[card.color] ?? "border-black"} p-8 rounded-[32px] flex flex-col gap-[12px] md:gap-[24px] items-center justify-start shadow-md transition-all duration-300 ease-in-out hover:shadow-lg hover:border-b-8 cursor-pointer group`}>
