    ...
    return (
        ...
        >
            ...
            <div className="flex-1  relative" role="img" aria-labelledby="mockup-description">
                <Reveal className="fade-left delay-1">
                    <Image
            ...
            <div className="flex-1 my-auto" role="main">
                ...
                <Reveal>
                    <h1
                        ...
                        className="hidden md:block text-[48px] font-bold bg-gradient-to-r from-[#025E98] to-[#192849] bg-clip-text text-transparent leading-[1]"
                    ...
                    <h1
                        className="md:hidden text-[24px] font-bold text-center bg-gradient-to-r from-[#025E98] to-[#192849] bg-clip-text text-transparent leading-[1]"
                        aria-label="Tenha o Super São Geraldo"
                    >
                        Tenha o <br />
                    ...
                    <h2 className="text-2xl md:text-[52px] text-center md:text-start md:-mt-2 bg-gradient-to-r from-[#F28E28] font-bold to-[#EB6128] leading-[1.2] bg-clip-text text-transparent">
                        na palma da sua mão!
                    </h2>
